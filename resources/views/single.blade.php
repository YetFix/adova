        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-8 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    <h3>{{$product->name}}</h3>
                    <h3>Composition</h3>
                    <p class="mb-4">{!! $product->compostion !!}</p>
                    <h3>Indication</h3>
                    <p class="mb-4">{!! $product->indication !!}</p>
                    <h3>Dosage</h3>
                    <p class="mb-4">{!! $product->dosage !!}</p>
                    <h3>Supply</h3>
                    <p class="mb-4">{!! $product->supply !!}</p>
                    <h3>Price</h3>
                    <h2 class="font-weight-semi-bold mb-4">{{$product->price}} tk.</h2>
                ...
                <div class="owl-carousel related-carousel">
                    ...
                    <div class="product-item bg-light" onclick="location.href='/f/products/{{$product->id}}';" style="cursor:pointer;">
                        ...
                        <img src="{{ asset('/product_images/'. $property_images[0]) }}" class="img-fluid" style="height:300px;" alt="">  
                            ...
                            <a class="h6 text-decoration-none text-truncate" href="" style="color:white;font-size:30px;">{{$product->name}}</a>
